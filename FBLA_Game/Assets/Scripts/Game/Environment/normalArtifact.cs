...
{
    public class normalArtifact : MonoBehaviour
    {
        ...
        private IEnumerator onCollect()
        {
            ...
            int numOfAmulets = FindObjectOfType<ArtifactHolder>().TotalArtifacts;
            ...
            artifactPlacer.transform.parent.Find("Door").GetComponent<ArtifactHolder>().ArtifactCollected();
        }
