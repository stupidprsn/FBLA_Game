...
namespace JonathansAdventure.Game.Normal
{
    ...
    public abstract class Player : MonoBehaviour
    {
        ...
        /// <summary>
        ///     The axis used to input horizontal movement.
        /// </summary>
        abstract private protected float HorizontalAxis { get; }
        /// <summary>
        ///     The input key used to signal a jump.
        /// </summary>
        abstract private protected bool JumpKey { get; }
        /// <summary>
        ///     The input key used to signal an interaction (collect & inter door).
        /// </summary>
        abstract internal protected bool InteractKey { get; }
